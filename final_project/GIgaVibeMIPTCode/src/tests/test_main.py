...
def test_print_streaming_answer(capsys) -> None:
    ...
    answer = _print_streaming_answer(FakeClient(),[ChatMessage(role="user", content="hi")])
...
def test_main_exits(monkeypatch, capsys) -> None:
...
def test_main_handles_config_error(monkeypatch, capsys) -> None:
    import src.main.main as main_module
